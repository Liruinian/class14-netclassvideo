!function(a, b) {
    ...
    return function(a) {
        ...
        window.webpackJsonpcyberplayer = function(d, f) {
            for (var g, h, i = 0, j = []; i < d.length; i++)
                h = d[i],
                e[h] && j.push.apply(j, e[h]),
                e[h] = 0;
            for (g in f)
                a[g] = f[g];
            for (c && c(d, f); j.length; )
                j.shift().call(null, b)
        }
        ;
        var d = {}
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function() {
            ...
            s.contains = s.include = function(a, b) {
                return null != a && (a.length !== +a.length && (a = s.values(a)),
                s.indexOf(a, b) >= 0)
            }
            ,
            ...
            s.throttle = function(a, b, c) {
                ...
                return function() {
                    ...
                    h = j,
                    f = a.apply(d, e),
                    d = e = null) : g || !1 === c.trailing || (g = setTimeout(i, k)),
                    f
                }
            }
            ,
    ...
    , function(a, b, c) {
        ...
        ;
        d = [c(8), c(1), c(63), c(27), c(15), c(42), c(65), c(62), c(44), c(123), c(126), c(124)],
        void 0 !== (e = function(a, b, c, d, e, g, h, i, j, k, l, m) {
            ...
            n.foreach = function(a, b) {
                var c, d;
                for (c in a)
                    "function" === n.typeOf(a.hasOwnProperty) ? a.hasOwnProperty(c) && (d = a[c],
                    b(c, d)) : (d = a[c],
                    b(c, d))
            }
            ,
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a) {
            var b = []
              ...
              , d = {
                on: function(a, b, c) {
                    return g(this, "on", a, [b, c]) && b ? (this._events || (this._events = {}),
                ...
                off: function(b, c, d) {
                    var e, f, h, i, j, k, l, m;
                    if (!this._events || !g(this, "off", b, [c, d]))
                        return this;
                    if (!b && !c && !d)
                        return this._events = void 0,
                        this;
                    for (i = b ? [b] : a.keys(this._events),
                    j = 0,
                    k = i.length; j < k; j++)
                        if (b = i[j],
                        h = this._events[b]) {
              ...
              , g = function(a, b, c, d) {
                ...
                if ("object" === (void 0 === c ? "undefined" : f(c))) {
                    for (var g in c)
                        a[b].apply(a, [g, c[g]].concat(d));
                    return !1
                }
                if (e.test(c)) {
                    for (var h = c.split(e), i = 0, j = h.length; i < j; i++)
                        a[b].apply(a, [h[i]].concat(d));
                    return !1
                }
                return !0
            }
              , h = function(a, b, c) {
                ...
                case 0:
                    for (; ++e < f; )
                        (d = a[e]).callback.call(d.context || c);
                    return;
                case 1:
                    for (; ++e < f; )
                        (d = a[e]).callback.call(d.context || c, g);
                    return;
                case 2:
                    for (; ++e < f; )
                        (d = a[e]).callback.call(d.context || c, g, h);
                    return;
                case 3:
                    for (; ++e < f; )
                        (d = a[e]).callback.call(d.context || c, g, h, i);
                    return;
                default:
                    for (; ++e < f; )
        ...
        void 0 !== (e = function(a) {
            ...
            var c = function(a) {
              ...
              , h = function(b) {
                ...
                var c = b.split(":")
                  , d = 0;
                return "s" === b.slice(-1) ? d = parseFloat(b) : "m" === b.slice(-1) ? d = 60 * parseFloat(b) : "h" === b.slice(-1) ? d = 3600 * parseFloat(b) : c.length > 1 ? (d = parseFloat(c[c.length - 1]),
                d += 60 * parseFloat(c[c.length - 2]),
                3 === c.length && (d += 3600 * parseFloat(c[c.length - 3]))) : d = parseFloat(b),
                d
            }
              , i = function(b, c) {
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d) {
            ...
            function h(a) {
                (d.isPoorIE() || a instanceof MouseEvent || a instanceof window.TouchEvent) && (a.preventManipulation && a.preventManipulation(),
            ...
            var i = !c.isUndefined(window.PointerEvent)
              ...
              , m = function(a, j) {
                ...
                function p(b) {
                    ...
                    x = e(b, "X"),
                    y = e(b, "Y"),
                    f(b) || (i ? b.isPrimary && (j.preventScrolling && (u = b.pointerId,
                    a.setPointerCapture(u)),
                    d.addEventListener(a, "pointermove", q),
                    d.addEventListener(a, "pointercancel", r),
                    d.addEventListener(a, "pointerup", r)) : k && (d.addEventListener(document, "mousemove", q),
                    l && "object" === b.target.nodeName.toLowerCase() ? d.addEventListener(a, "click", r) : d.addEventListener(document, "mouseup", r)),
                    t && (d.addEventListener(t, "touchmove", q),
                    d.addEventListener(t, "touchcancel", r),
                    d.addEventListener(t, "touchend", r)))
                }
                function q(a) {
                    var c = b.touchEvents;
                    if (w)
                ...
                function r(c) {
                    var e = b.touchEvents;
                    i ? (j.preventScrolling && a.releasePointerCapture(u),
                    d.removeEventListener(a, "pointermove", q),
                    d.removeEventListener(a, "pointercancel", r),
                    d.removeEventListener(a, "pointerup", r)) : k && (d.removeEventListener(document, "mousemove", q),
                    d.removeEventListener(document, "mouseup", r)),
                    t && (d.removeEventListener(t, "touchmove", q),
                    d.removeEventListener(t, "touchcancel", r),
                    d.removeEventListener(t, "touchend", r)),
                    w ? s(e.DRAG_END, c) : j.directSelect && c.target !== a || -1 !== c.type.indexOf("cancel") || (i && c instanceof window.PointerEvent ? "touch" === c.pointerType ? s(e.TAP, c) : s(e.CLICK, c) : k ? s(e.CLICK, c) : (s(e.TAP, c),
                    h(c))),
                    t = null,
                    w = !1
                }
                function s(a, d) {
                    var e;
                    if (j.enableDoubleTap && (a === b.touchEvents.CLICK || a === b.touchEvents.TAP))
                        if (c.now() - z < A) {
                ...
                var t, u, v = a, w = !1, x = 0, y = 0, z = 0, A = 300;
                j = j || {},
                i ? (d.addEventListener(a, "pointerdown", p),
                j.useHover && (d.addEventListener(a, "pointerover", m),
                d.addEventListener(a, "pointerout", o)),
                j.useMove && d.addEventListener(a, "pointermove", n)) : k && (d.addEventListener(a, "mousedown", p),
                j.useHover && (d.addEventListener(a, "mouseover", m),
                d.addEventListener(a, "mouseout", o)),
                j.useMove && d.addEventListener(a, "mousemove", n)),
                ...
                this.destroy = function() {
                    ...
                    d.removeEventListener(t, "touchend", r)),
                    i && (j.preventScrolling && a.releasePointerCapture(u),
                    d.removeEventListener(a, "pointerover", m),
                    d.removeEventListener(a, "pointerdown", p),
                    d.removeEventListener(a, "pointermove", q),
                    d.removeEventListener(a, "pointermove", n),
                    d.removeEventListener(a, "pointercancel", r),
                    d.removeEventListener(a, "pointerout", o),
                    d.removeEventListener(a, "pointerup", r)),
    ...
    , , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b) {
            ...
            var e = function(a, c, d) {
              ...
              , j = function(a, b) {
                var c = "rgb";
                a ? (a = String(a).replace("#", ""),
                3 === a.length && (a = a.charAt(0) + a.charAt(0) + a.charAt(1) + a.charAt(1) + a.charAt(2) + a.charAt(2))) : a = "000000";
        ...
        void 0 !== (e = function(a, b, d, e) {
            ...
            e.extend(f.prototype, {
                reorderProviders: function() {
                    ...
                    d = this.providers.splice(c, 1)[0],
                    this.providers.push(d),
                    this.providers.push(b)),
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            d.bounds = function(a) {
                ...
                return c.width || c.height || c.left || c.top ? (b.left = c.left + e,
                b.right = c.right + e,
                b.top = c.top + d,
                b.bottom = c.bottom + d,
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(2), c(20), c(47), c(85), c(1), c(3), c(125), c(4), c(7), c(76)],
            ...
            var k = function() {
                function g(a, b) {
                    ...
                    case h.JWPLAYER_MEDIA_TYPE:
                        return void (this.mediaModel.get("mediaType") !== b.mediaType && (this.mediaModel.set("mediaType", b.mediaType),
                    ...
                    case h.JWPLAYER_MEDIA_META:
                        var f = b.duration;
                        e.isNumber(f) && (this.mediaModel.set("duration", f),
                        this.set("duration", f)),
                    ...
                    case h.JWPLAYER_MEDIA_TIME:
                        ...
                        e.isNumber(b.duration) && (this.mediaModel.set("duration", b.duration),
                        this.set("duration", b.duration),
                        b.duration > 0 && this.recordMediaPosition(b.position, b.duration),
                        b.duration === 1 / 0 && this.trigger("alive")),
                ...
                this.changeVideoProvider = function(a) {
                    ...
                    m && (m.off(null, null, this),
                    m.getContainer() && m.remove()),
                    !a)
                        return m = q = a,
                    ...
                    -1 === q.getName().name.indexOf("flash") && (this.set("flashThrottle", void 0),
                ...
                this.setProvider = function(a) {
                    ...
                    if (void 0 !== b) {
                        ...
                        q && (q.init && q.init(a, this.attributes),
    ...
    , , , , , , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b) {
            function c(a) {
                ...
                var e = 1;
                if (c[0].indexOf(" --\x3e ") > 0 && (e = 0),
                c.length > e + 1 && c[e + 1]) {
                    var f = c[e]
                      , g = f.indexOf(" --\x3e ");
                    g > 0 && (b.begin = d(f.substr(0, g)),
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function() {
            ...
            window.btoa || (window.btoa = function(c) {
                for (var d, e, f = String(c), g = 0, h = b, i = ""; f.charAt(0 | g) || (h = "=",
                g % 1); i += h.charAt(63 & d >> 8 - g % 1 * 8)) {
                    if ((e = f.charCodeAt(g += .75)) > 255)
            ...
            window.atob || (window.atob = function(c) {
                ...
                for (var e, f, g = 0, h = 0, i = ""; f = d.charAt(h++); ~f && (e = g % 4 ? 64 * e + f : f,
                g++ % 4) ? i += String.fromCharCode(255 & e >> (-2 * g & 6)) : 0)
                    f = b.indexOf(f);
                return i
            }
            )
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function() {
            ...
            function() {
                ...
                function c(a, d) {
                    var e, i, k, l, m, n = g, o = d[a];
                    switch (o && "object" === (void 0 === o ? "undefined" : f(o)) && "function" == typeof o.toJSON && (o = o.toJSON(a)),
                    "function" == typeof j && (o = j.call(d, a, o)),
                    void 0 === o ? "undefined" : f(o)) {
                    case "string":
                        return b(o);
                    case "number":
                    ...
                    case "object":
                        ...
                        if (j && "object" === (void 0 === j ? "undefined" : f(j)))
                            for (l = j.length,
                            e = 0; e < l; e += 1)
                                "string" == typeof j[e] && (i = j[e],
                                (k = c(i, o)) && m.push(b(i) + (g ? ": " : ":") + k));
                        else
                            for (i in o)
                                Object.prototype.hasOwnProperty.call(o, i) && (k = c(i, o)) && m.push(b(i) + (g ? ": " : ":") + k);
                        return k = 0 === m.length ? "{}" : g ? "{\n" + g + m.join(",\n" + g) + "\n" + n + "}" : "{" + m.join(",") + "}",
                        g = n,
                        k
                    }
                ...
                JSON.stringify = function(a, b, d) {
                    ...
                    "number" == typeof d)
                        ...
                        "string" == typeof d && (h = d);
                    if (j = b,
                    b && "function" != typeof b && ("object" !== (void 0 === b ? "undefined" : f(b)) || "number" != typeof b.length))
                ...
                "function" != typeof JSON.parse && (d = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
                JSON.parse = function(a, b) {
                    function c(a, d) {
                        var e, g, h = a[d];
                        if (h && "object" === (void 0 === h ? "undefined" : f(h)))
                            for (e in h)
                                Object.prototype.hasOwnProperty.call(h, e) && (g = c(h, e),
                                void 0 !== g ? h[e] = g : delete h[e]);
                        return b.call(a, d, h)
                    }
                    var e;
                    if (a = String(a),
        ...
        void 0 !== (e = function(a) {
                ...
                try {
                    ...
                    if (a && ("object" === (void 0 === a ? "undefined" : f(a)) || "function" == typeof a)) {
                        ...
                        if ("function" == typeof c)
                            return void j(b(c, a), b(e, this), b(g, this))
                    }
                    this._state = !0,
                    this._value = a,
                    h.call(this)
            ...
            c.all = function() {
                ...
                return new c(function(b, c) {
                        ...
                        try {
                            if (h && ("object" === (void 0 === h ? "undefined" : f(h)) || "function" == typeof h)) {
                                ...
                                if ("function" == typeof i)
                                    return void i.call(h, function(a) {
                                        d(g, a)
                                    }, c)
                            }
                            a[g] = h,
                    ...
                    if (0 === a.length)
                        return b([]);
                    for (var e = a.length, g = 0; g < a.length; g++)
                        d(g, a[g])
                }
                )
            }
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(2), c(1), c(4), c(7), c(121), c(26), c(3)],
        void 0 !== (e = function(a, b, c, d, e, f, g) {
            ...
            function j(j, k) {
                ...
                var q, r, s, t = null, u = -1, v = !1, w = -1, x = null, y = -1, z = null, A = !0, B = !1, C = null, D = this, E = function() {
                    return r && r.__ready
                }, F = function() {
                ...
                b.extend(this, g, {
                    ...
                    attachMedia: function() {
                        A = !0,
                        v && (this.setState(d.COMPLETE),
                        this.trigger(c.JWPLAYER_MEDIA_COMPLETE),
                        v = !1)
                    },
                    ...
                    getSwfObject: function(a) {
                        ...
                        return b ? (b.off(null, null, this),
                        b) : e.embed(k.flashplayer, a, h(j), k.wmode, k.playlistItem, k.flashUI)
                    },
                ...
                this.trigger = function(a, b) {
                    if (A)
                        return g.trigger.call(this, a, b)
                }
            }
            var k = 0
              , l = function() {};
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d, e, f, g, h, i) {
            ...
            function m(m, x) {
                function y() {
                    ya && (ia(Ma.audioTracks),
                    sa.setTextTracks(Ma.textTracks),
                    Ma.setAttribute("jw-loaded", "data"),
                    Ka.isLive && J())
                }
                function z() {
                ...
                function D() {
                    n(wa),
                    ua = !0,
                    ya && (sa.state === f.STALLED ? sa.setState(f.PLAYING) : sa.state === f.PLAYING && (wa = setTimeout(aa, o)),
                    Aa && Ma.duration === 1 / 0 && 0 === Ma.currentTime || (I(H()),
                    G(Ma.currentTime),
                    F(ba(), pa, oa),
                    sa.state === f.PLAYING && (sa.trigger(e.JWPLAYER_MEDIA_TIME, {
                        position: pa,
                        duration: oa
                    }),
                    E())))
                ...
                function E() {
                    ...
                    if (a.width !== Ma.videoWidth || a.height !== Ma.videoHeight) {
                        if (a.width = Ma.videoWidth,
                        a.height = Ma.videoHeight,
                        ma(),
                        !a.width || !a.height)
                            return;
                ...
                function F(a, b, c) {
                    a === xa && c === oa || (xa = a,
                    sa.trigger(e.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 100 * a,
                        position: b,
                        duration: c
                    }))
                ...
                function L() {
                    ya && (Ma.muted && (Ma.muted = !1,
                    Ma.muted = !0),
                    Ma.setAttribute("jw-loaded", "meta"),
                    J())
                }
                function M() {
                    qa || (qa = !0,
                    sa.trigger(e.JWPLAYER_MEDIA_BUFFER_FULL))
                }
                function N() {
                ...
                function V(a, c) {
                    ...
                    e || "none" === g || "started" === g ? (oa = c,
                    sa.setupSideloadedTracks(Ha),
                    b.isHtml5Flv(ra[za].file, ra[za].type) && Ja ? (Ja.load(),
                    Ja.play()) : (W(ra[za]),
                    Ma.load()),
                    s && Ma.paused && U()) : (0 === a && Ma.currentTime > 0 && (va = -1,
                    sa.seek(a)),
                    b.isHtml5Flv(ra[za].file, ra[za].type) && Ja ? Ja.play() : U()),
                    pa = Ma.currentTime,
                    r && !h && (M(),
                    Ma.paused || sa.state === f.PLAYING || sa.setState(f.LOADING)),
                ...
                function W(a) {
                    ...
                    Fa = -1,
                    Ga = -1,
                    Ia.reason || (Ia.reason = "initial choice",
                    Ia.level = {}),
                    ua = !1,
                    qa = !1,
                    Aa = l(a);
                    ...
                    c.src = a.file,
                    Ma.src !== c.src && (Ma.setAttribute("jw-loaded", "none"),
                    Ma.src = a.file)
                }
                function X() {
                    Ma && (sa.disableTextTrack(),
                    Ma.removeAttribute("crossorigin"),
                    Ma.removeAttribute("preload"),
                    Ma.removeAttribute("src"),
                    Ma.removeAttribute("jw-loaded"),
                    Ma.removeAttribute("jw-played"),
                    c.emptyElement(Ma),
                    za = -1,
                    Ha = null,
                    !q && "load"in Ma && Ma.load(),
                    sa.trigger("stop"))
                }
                function Y() {
                    for (var a = Ma.seekable ? Ma.seekable.length : 0, b = 1 / 0; a--; )
                        b = Math.min(b, Ma.seekable.start(a));
                    return b
                }
                function Z() {
                    for (var a = Ma.seekable ? Ma.seekable.length : 0, b = 0; a--; )
                        b = Math.max(b, Ma.seekable.end(a));
                    return b
                }
                function $() {
                    sa.seeking = !1,
                ...
                function ca() {
                    if (ya && sa.state !== f.IDLE && sa.state !== f.COMPLETE) {
                        ...
                        za = -1,
                        Ca = !0,
                        sa.trigger(e.JWPLAYER_MEDIA_BEFORECOMPLETE),
                        !ya)
                            return;
                        da()
                    }
                ...
                function fa() {
                    for (var a = -1, b = 0; b < Ma.audioTracks.length; b++)
                        if (Ma.audioTracks[b].enabled) {
                            a = b;
                            break
                        }
                    ja(a)
                ...
                function ja(a) {
                    Ma && Ma.audioTracks && Ea && a > -1 && a < Ma.audioTracks.length && a !== Fa && (Ma.audioTracks[Fa].enabled = !1,
                    Fa = a,
                    Ma.audioTracks[Fa].enabled = !0,
                    sa.trigger("audioTrackChanged", {
                        currentTrack: Fa,
                        tracks: Ea
                    }))
                }
                ...
                this.trigger = function(a, b) {
                    if (ya)
                        return h.trigger.call(this, a, b)
                }
                ,
                this.setState = function(a) {
                    if (ya)
                        return g.setState.call(this, a)
                }
                ;
                var na, oa, pa, qa, ra, sa = this, ta = {
                    click: A,
                    durationchange: B,
                    ended: ca,
                    error: Q,
                ...
                }, ua = !1, va = 0, wa = -1, xa = -1, ya = !0, za = -1, Aa = null, Ba = !!x.sdkplatform, Ca = !1, Da = !1, Ea = null, Fa = -1, Ga = -1, Ha = null, Ia = {
                    level: {}
                }, Ja = null, Ka = null, La = document.getElementById(m), Ma = La ? La.querySelector("video") : void 0;
                ...
                Ma.setAttribute("x5-video-player-type", "h5-page"),
                Ma.setAttribute("x5-video-player-fullscreen", "true"),
                this.stop = function() {
                    n(wa),
                    ya && (X(),
                    b.isIETrident() && Ma.pause(),
                ...
                this.init = function(a, c) {
                    ...
                    Ia.reason = "",
                    W(ra[za]),
                    this.setupSideloadedTracks(a.tracks),
                    Ha = this.itemTracks,
                    Ka = c,
                    b.isHtml5Flv(ra[za].file, ra[za].type) && this.initFlvPlayer(),
                    Ka.crossoriginAnonymous && Ma.setAttribute("crossorigin", "anonymous"))
                }
                ,
                this.initFlvPlayer = function() {
                    ...
                    Ka.minBufferLength > 0 && (b.lazyLoadMaxDuration = Ka.minBufferLength,
                    Ka.minBufferLength < 30 && (b.lazyLoadRecoverDuration = Ka.minBufferLength));
                    var c = d.extend({
                        hasAudio: !0,
                        hasVideo: !0,
                        isLive: Ka.isLive,
                    ...
                    Ja.on(e.JWPLAYER_ERROR, function(b, c, d) {
                        "CodecUnsupported" === c && (Ja.unload(),
                        Ja.detachMediaElement()),
                ...
                this.load = function(a) {
                    ya && (S(a.sources),
                    a.sources.length && "hls" !== a.sources[0].type && this.sendMediaType(a.sources),
                    r && !Ma.hasAttribute("jw-played") || sa.setState(f.LOADING),
                    V(a.starttime || 0, a.duration || 0))
                }
                ,
                this.play = function() {
                    return sa.seeking ? (sa.setState(f.LOADING),
                    void sa.once(e.JWPLAYER_MEDIA_SEEKED, sa.play)) : void U()
                }
                ,
                this.pause = function() {
                    n(wa),
                ...
                this.seek = function(a) {
                    if (ya)
                        if (a < 0 && (a += Y() + Z()),
                        0 === va && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
                ...
                this.resize = function(b, c, d) {
                    if (!(b && c && Ma.videoWidth && Ma.videoHeight))
                        return !1;
                    var e = {
                        objectFit: ""
                    };
                    if ("uniform" === d) {
                        ...
                        Math.abs(f - g) < .09 && (e.objectFit = "fill",
                        d = "exactfit")
                    }
                    if (p || t || u || v) {
                ...
                this.setPlaybackRate = function(a) {
                    Ka.isLive || (Ma.playbackRate = a,
                    this.trigger(e.JWPLAYER_PLAYBACKRATE, {
                        playbackRate: a
                    }))
                }
            }
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b) {
            ...
            return e.getAbsolutePath = function(a, d) {
                if (b.exists(d) || (d = document.location.href),
                b.exists(a)) {
                    if (c(a))
                        return a;
                    var e, f = d.substring(0, d.indexOf("://") + 3), g = d.substring(f.length, d.indexOf("/", f.length + 1));
                    if (0 === a.indexOf("/"))
                        e = a.split("/");
                    else {
                        var h = d.split("?")[0];
            ...
            e.parseXML = function(a) {
                var b = null;
                try {
                    "DOMParser"in window ? (b = (new window.DOMParser).parseFromString(a, "text/xml"),
                    (d(b.childNodes) || b.childNodes && d(b.childNodes[0].childNodes)) && (b = null)) : (b = new window.ActiveXObject("Microsoft.XMLDOM"),
                    b.async = "false",
                    b.loadXML(a))
                } catch (c) {}
                return b
            ...
            e.serialize = function(a) {
                ...
                if ("string" == typeof a && a.length < 6) {
                    ...
                    if ("false" === b)
                        return !1;
                    if (!isNaN(Number(a)) && !isNaN(parseFloat(a)))
                        return Number(a)
                }
                return a
            }
            ...
            var d = {}
              ...
              , f = function(f, g) {
                ...
                this.load = function() {
                    if (k === e.NEW) {
                        var b = d[f];
                        if (b && (k = b.getStatus()) < 2)
                            return b.on(a.ERROR, h),
                            void b.on(a.COMPLETE, i);
                        var c = document.getElementsByTagName("head")[0] || document.documentElement
                          , j = this.makeTag(f)
                          , l = !1;
                        j.onload = j.onreadystatechange = function(a) {
                            l || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (l = !0,
                            i(a),
        ...
        void 0 !== (e = function(a, b, c, d) {
            return a.extend({
                ...
                dragMove: function(a) {
                    ...
                    "horizontal" === this.orientation ? (b = a.pageX,
                    c = b < e.left ? 0 : b > e.right ? 100 : 100 * d.between((b - e.left) / e.width, 0, 1)) : (b = a.pageY,
                    c = b >= e.bottom ? 0 : b <= e.top ? 100 : 100 * d.between((e.height - (b - e.top)) / e.height, 0, 1));
                    var f = this.limit(c);
                ...
                render: function(a) {
                    ...
                    "horizontal" === this.orientation ? (this.elementThumb.style.left = a + "%",
                    this.elementProgress.style.width = a + "%") : (this.elementThumb.style.bottom = a + "%",
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(73), c(1), c(20), c(60), c(36)],
        void 0 !== (e = function(a, b, c, d, e) {
            var f = []
              , g = 0
              , h = function(b) {
                var c, d;
                return b ? "string" == typeof b ? (c = i(b)) || (d = document.getElementById(b)) : "number" == typeof b ? c = f[b] : b.nodeType && (d = b,
                c = i(d.id)) : c = f[0],
                c || (d ? j(new a(d,k)) : {
    ...
    , , , , , , , , , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            return function(e) {
                ...
                a.isArray(f.captions) && (f.tracks = f.tracks.concat(f.captions),
                delete f.captions),
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(19), c(113), c(2), c(4), c(3), c(1)],
        void 0 !== (e = function(a, b, c, d, e, f) {
            return function() {
                function g(e) {
                    c.tryCatch(function() {
                        var c, g = e.responseXML ? e.responseXML.childNodes : null, h = "";
                        if (g) {
                            for (var k = 0; k < g.length && (h = g[k],
                            8 === h.nodeType); k++)
                                ;
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            return function(e) {
                if (e && e.file) {
                    ...
                    var g = /^[^\/]+\/(?:x-)?([^\/]+)$/;
                    if (a.isRtmp(f.file) ? f.type = "rtmp" : g.test(f.type) ? f.type = f.type.replace(g, "$1") : f.type || (f.type = b.extension(f.file)),
                    f.type) {
                        switch (f.type) {
                        case "m3u8":
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d, e, g) {
            ...
            return function(i) {
                ...
                var m, n, o, p, q = g.extend(this, d), r = e.loaderstatus.NEW;
                this.load = function() {
                    if (r === e.loaderstatus.NEW) {
                        if (i.lastIndexOf(".swf") > 0)
                            return m = i,
                            r = e.loaderstatus.COMPLETE,
                            void q.trigger(c.COMPLETE);
                        if (b.getPluginPathType(i) === b.pluginPathType.CDN)
                            return r = e.loaderstatus.COMPLETE,
                            void q.trigger(c.COMPLETE);
                ...
                this.registerPlugin = function(a, b, d, f) {
                    ...
                    o = b,
                    d && f ? (m = f,
                    n = d) : "string" == typeof d ? m = d : "function" == typeof d ? n = d : d || f || (m = a),
                    r = e.loaderstatus.COMPLETE,
                    q.trigger(c.COMPLETE)
                }
                ,
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            return [{
                ...
                supports: function(b) {
                    ...
                    if (!e[g])
                        return !1;
                    if (a.isEdge() && a.isHls(f, g))
                        return !1;
                    if (a.isPoorIE())
                        return !1;
                    if (a.isHls(f, g) && a.isSafari() && !a.isMobile())
                        return !1;
                    if (c.canPlayType) {
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d) {
                        ...
                        b; b < c; b++) {
                            ...
                            if (!u[b + d.kind])
                                if ("metadata" === d.kind)
                                    ...
                                    var f = d.mode;
                                    if (d.mode = "hidden",
                                    !d.cues.length && "caterpillar" === this.getName().name && "Unknown CC" === d.label)
                                        continue;
                                    d.mode = f,
                                    t.push(d),
                                    u[b + d.kind] = d,
            ...
            function g(a) {
                ...
                !this._isSDK && b && a && (h.call(this, a) || (r(),
                d.emptyElement(this.video),
                i(),
                this.itemTracks = a,
                j.call(this, a)))
            }
                    ...
                    for (var d = 0; d < a.length; d++) {
                        ...
                        if (/\.(?:web)?vtt(?:\?.*)?$/i.test(e.file)) {
                            if (/subtitles|captions|descriptions|chapters|metadata/i.test(e.kind)) {
                                b || !this.video.hasAttribute("crossorigin") && c.crossdomain(e.file) && (this.video.setAttribute("crossorigin", "anonymous"),
                                b = !0);
        ...
        void 0 !== (e = function(a, b) {
            ...
            function d(b, d) {
                return function(e) {
                    ...
                    if (clearTimeout(d.timeoutId),
                    d.retryWithoutCredentials && d.xhr.withCredentials) {
                        c(f);
                        var g = a.extend({}, d, {
                            xhr: null,
                            withCredentials: !1,
            ...
            function f(a) {
                return function(c) {
                    ...
                    a.responseType) {
                        ...
                        if (f && e)
                            return h(d, f, a);
                        if (j && d.responseText && !f && (f = b.parseXML(d.responseText)) && f.firstChild)
                            return h(d, f, a);
                        if (a.requireValidXML)
                            return void a.onerror("Invalid XML", a.url, d)
                    }
                    a.oncomplete(d)
                }
            }
            function g(b, c) {
                if (!b.response || a.isString(b.response) && '"' !== b.responseText.substr(1))
                    try {
                        b = a.extend({}, b, {
            ...
            var i = function() {}
              ...
              , l = function(b, g, h, l) {
                ...
                if ("XDomainRequest"in window && k(b))
                    m = n.xhr = new window.XDomainRequest,
                    m.onload = f(n),
                    m.ontimeout = m.onprogress = i,
                    j = !0;
                else {
                    if (!("XMLHttpRequest"in window))
                        return void n.onerror("", b);
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a) {
            ...
            var f = c.isIETrident = function(a) {
                return !!c.isEdge() || (a ? (a = parseFloat(a).toFixed(1),
                d(new RegExp("trident/.+rv:\\s*" + a,"i"))) : d(/trident/i))
            }
              , g = c.isMSIE = function(a) {
                return a ? (a = parseFloat(a).toFixed(1),
                d(new RegExp("msie\\s*" + a,"i"))) : d(/msie/i)
            }
              , h = b(/chrome/i);
            c.isChrome = function() {
                return h() && !c.isEdge()
            ...
            var j = c.isAndroid = function(a, b) {
                return !(b && d(/chrome\/[123456789]/i) && !d(/chrome\/18/)) && (a ? (e(a) && !/\./.test(a) && (a += "."),
                d(new RegExp("Android\\s*" + a,"i"))) : d(/Android/i))
            }
            ;
            ...
            c.flashVersion = function() {
                ...
                if (b && (a = b["Shockwave Flash"]) && a.description)
                    return parseFloat(a.description.replace(/\D+(\d+\.?\d*).*/, "$1"));
                if ("undefined" != typeof window.ActiveXObject) {
                    try {
                        if (a = new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash"))
                            return parseFloat(a.GetVariable("$version").split(" ")[1].replace(/\s*,\s*/, "."))
                    } catch (d) {
                        return 0
                    }
                    return a
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a) {
            ...
            b.utf16BigEndianArrayToStr = function(a, b) {
                ...
                e = a.length - 1,
                d = b || 0; d < e; )
                    254 === a[d] && 255 === a[d + 1] || (c += String.fromCharCode((a[d] << 8) + a[d + 1])),
                    d += 2;
                return c
            }
            ,
            ...
            b.parseID3 = function(d) {
                return a.reduce(d, function(d, e) {
                    if (!("value"in e) && "data"in e && e.data instanceof ArrayBuffer) {
                        ...
                        for (var i = 10; i < 14 && i < g.length && 0 !== g[i]; )
                            e.value.key += String.fromCharCode(g[i]),
                            i++;
                        var j = 19
                          , k = g[j];
                        3 !== k && 0 !== k || (k = g[++j],
                    ...
                    if (c.hasOwnProperty(e.value.key) && (d[c[e.value.key]] = e.value.data),
                    e.value.info) {
                        var r = d[e.value.key];
                        a.isObject(r) || (r = {},
                        d[e.value.key] = r),
    ...
    , function(a, b, c) {
        ...
        void 0 !== (d = function(require, a, b) {
            ...
            function d(a) {
                var b = k[a];
                if (b) {
                    for (var c = Object.keys(b), d = 0; d < c.length; d += 1)
                        for (var e = b[c[d]], f = 0; f < e.parts.length; f += 1)
                            e.parts[f]();
                    delete k[a]
                }
            }
                ...
                for (var c = 0; c < b.length; c++) {
                    ...
                    if (e) {
                        ...
                        for (; f < d.parts.length; f++)
                            e.parts.push(i(a, d.parts[f]))
                    } else {
                        for (var g = [], f = 0; f < d.parts.length; f++)
                            g.push(i(a, d.parts[f]));
                        k[a] = k[a] || {},
                        k[a][d.id] = {
                            id: d.id,
                            parts: g
            ...
            function i(a, b) {
                ...
                function(a) {
                    if (a) {
                        if (a.css === b.css && a.media === b.media)
                            return;
                        d(b = a)
                    } else
                        e()
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(4), c(7), c(3), c(2), c(66), c(1), c(81), c(71), c(72), c(74), c(78), c(17)],
        void 0 !== (e = function(a, b, c, d, e, f, g, h, i, j, k, l) {
            return function(m, n) {
                ...
                this.getPlaylistItem = function(a) {
                    if (!d.exists(a))
                        return o._model.get("playlistItem");
                    var b = p.getPlaylist();
                    return b ? b[a] : null
                }
                ,
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b) {
            ...
            function g(b, c) {
                if (-1 === c.toString().indexOf("%"))
                    return 0;
                if ("string" != typeof b || !a.exists(b))
                    return 0;
                if (/^\d*\.?\d+%$/.test(b))
                    return b;
                var d = b.indexOf(":");
            ...
            return function(i, j) {
                ...
                var m = b.extend({}, h, l);
                if (m.options = i,
                void 0 === m.controlbar.canDrag && (m.controlbar.canDrag = !0),
                "." === m.base && (m.base = a.getScriptPath("cyberplayer.js")),
                m.playRate || (m.playbackRate = 1),
                m.base = (m.base || a.loadFrom()).replace(/\/?$/, "/"),
                c.p = m.base,
                m.width = e(m.width),
                m.height = e(m.height),
                m.flashplayer = m.flashplayer || a.getScriptPath("cyberplayer.js") + "cyberplayer.flash.swf",
                "http:" === window.location.protocol && (m.flashplayer = m.flashplayer.replace("https", "http")),
                m.aspectratio = g(m.aspectratio, m.width),
                b.isObject(m.skin) && (m.skinUrl = m.skin.url,
                m.skinColorInactive = m.skin.inactive,
                m.skinColorActive = m.skin.active,
                m.skinColorBackground = m.skin.background,
                m.skin = b.isString(m.skin.name) ? m.skin.name : h.skin),
                b.isString(m.skin) && m.skin.indexOf(".xml") > 0 && (console.log("JW Player does not support XML skins, please update your config"),
                m.skin = m.skin.replace(".xml", "")),
                m.aspectratio || delete m.aspectratio,
                !m.playlist) {
                    var n = b.pick(m, ["title", "description", "type", "mediaid", "image", "file", "sources", "tracks", "preload", "fallbackfile"]);
                    m.playlist = [n]
                }
                return a.isPoorIE() && (m = f(m)),
                a.isChrome66() && (m.originVolume = m.volume,
                m.volume = 0),
                m
            }
        }
        ...
        var f = c(175)
          ...
          , n = function() {
            function a(b) {
                e(this, a),
                this.api = null,
                b && b.advs && i["default"].isArray(b.advs) && b.advs.length ? (this.processAdvs = b.advs,
                this.hasProcessAdv = !0,
                this.el = k["default"].createElement((0,
                g["default"])())) : this.hasProcessAdv = !1,
                this.activeAdv = null
            }
            ...
            a.prototype.refreshProcessAdv = function(a) {
                ...
                b ? b !== this.activeAdv && (this.showAdv(b),
                this.activeAdv = b) : this.hideAllProcessAdvs()
            }
            ,
            ...
            a.prototype.element = function() {
                if (this.api) {
                    ...
                    if (k["default"].getElementsByClassName("jw-process-adv", a).length > 0)
                        return k["default"].getElementsByClassName("jw-process-adv", a)[0]
                }
                return this.el
            }
            ,
            ...
            function c(a) {
                for (var c = {}, d = a.substr(a.indexOf("?") + 1).split("&"), g = 0; g < d.length; g++) {
                    ...
                    if (i > -1) {
                        ...
                        b.contains(e, j) && (k = k.replace(/'/g, '"'),
                        k = "object" === ("undefined" == typeof JSON ? "undefined" : f(JSON)) && "function" == typeof JSON.parse ? JSON.parse(k) : eval("(" + k + ")")),
                        c[j] = k
                    }
                }
                return c
            ...
            function d() {
                for (var d = document.getElementsByTagName("script"), e = d.length; e--; ) {
                    ...
                    if (g.indexOf("cyberplayer.js") > -1) {
                        var h = c(g);
                        if (b.size(h) > 3 && "DIV" === f.parentNode.nodeName)
                            return a.selectPlayer(f.parentNode).setup(h)
                    }
                }
            }
        ...
        void 0 !== (e = function(a, b) {
            ...
            return e.prototype = {
                userCertify: function() {
                    if (!1 === this.config.withLog)
                        return !1;
                    var d = this.config.ak ? this.config.ak : "";
                    if (!/^[a-zA-Z0-9]{32}$/.test(d))
                        return c(),
                        !1;
                    var e = "web-html5-" + a
                      , f = b.getBrowserInfo()
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d) {
            var e = function(b, e, f, g) {
                ...
                function i() {
                    c.each(p, function(a) {
                        !0 !== a.complete && !0 !== a.running && null !== b && k(a.depends) && (a.running = !0,
                        j(a))
                    })
                }
                function j(a) {
                ...
                function l(a, b) {
                    "error" === b.type ? m(b.msg, b.reason, b.code || "") : "complete" === b.type ? (clearTimeout(n),
                    o.trigger(d.JWPLAYER_READY)) : (a.complete = !0,
                    i())
                }
                function m(a, b, c) {
                    clearTimeout(n),
            ...
            return function(e, f) {
                ...
                function h(a) {
                    ...
                    if (b && "textdata" === b.type) {
                        ...
                        var e, g;
                        b.useDTS ? (c.source || (c.source = b.source || "mpegts"),
                        e = b.begin,
                        g = b.begin + "_" + b.text) : (e = a.position || f.get("position"),
                ...
                function k(a) {
                    ...
                    var b, c, e, i, k = a.tracks, l = "flash" === f.get("provider").name, o = d.isChrome() || d.isIOS() || d.isSafari();
                    for (i = 0; i < k.length; i++)
                        b = k[i],
                        e = b.file && /\.(?:web)?vtt(?:\?.*)?$/i.test(b.file),
                        !l && e && !s && o || "captions" !== (c = b.kind.toLowerCase()) && "subtitles" !== c || (b.file ? (m(b),
                        n(b)) : b.data && m(b));
                    u.length || (f.mediaController.on("meta", h, this),
                ...
                function o(d, e) {
                    ...
                    if (f)
                        for ("xml" === a.localName(f) && (f = f.nextSibling); f.nodeType === f.COMMENT_NODE; )
                            f = f.nextSibling;
                    try {
                ...
                function q() {
                    ...
                    if ("Off" === b)
                        return void f.set("captionsIndex", 0);
    ...
    , function(a, b, c) {
        ...
        ;
        d = [c(75), c(82), c(1), c(79), c(80), c(28), c(47), c(114), c(57), c(2), c(147), c(20), c(3), c(29), c(7), c(4), c(141), c(117)],
        void 0 !== (e = function(a, b, c, d, e, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            ...
            return v.prototype = {
                ...
                setup: function(g, n) {
                    ...
                    function x(a) {
                        switch (ca.get("state") === p.ERROR && ca.set("state", p.IDLE),
                        B(!0),
                        ca.get("autostart") && ca.once("itemReady", A),
                        ...
                        case "object":
                            ...
                            m.load(e, c).then(function() {
                                fa.getProvider() || (ca.setProvider(ca.get("playlistItem")),
                                w())
                            });
                            G(a) && H(0);
                            break;
                    ...
                    function A(a) {
                        var b;
                        if (a && ca.set("playReason", a.reason),
                        ca.get("state") !== p.ERROR) {
                            var d = fa._instreamAdapter && fa._instreamAdapter.getState();
                            if (c.isString(d))
                                return n.pauseAd(!1);
                            if (ca.get("state") === p.COMPLETE && (B(!0),
                            H(0)),
                            !da) {
                                da = !0;
                                ...
                                if (e < 0 && f && ca.get("qualityLabel")) {
                                    for (var h = 0; h < f.sources.length; h++)
                                        f.sources[h].label.toString() === ca.get("qualityLabel").toString() && (e = h);
                                    "flash" === ca.getVideo().getName().name && (g = !0)
                                }
                                if (e < 0 && (e = 0),
                                fa.trigger(q.JWPLAYER_MEDIA_BEFOREPLAY, {
                            ...
                            if (D()) {
                                if (0 === ca.get("playlist").length)
                                    return !1;
                                !k.isPoorIE() && ca.get("imageAdvs") && ca.get("imageAdvs").start ? Z.beginStartAdv() : b = k.tryCatch(function() {
                                    ca.loadVideo()
                                })
                            } else
                                ca.get("state") === p.PAUSED && (b = k.tryCatch(function() {
                                    ca.playVideo()
                                }));
                            return !(b instanceof k.Error && (fa.triggerError(b),
                            aa = null,
                            1))
                        }
                    }
                    function B(a) {
                        ...
                        return c instanceof k.Error ? (fa.triggerError(c),
                        !1) : (b && (ea = !0),
                        da && (ba = !0),
                        !0)
                    }
                    function C() {
                        ...
                        case p.BUFFERING:
                            ...
                            if (b instanceof k.Error)
                                return fa.triggerError(b),
                                !1;
                            break;
                        default:
                            da && (ba = !0)
                    ...
                    function E(a) {
                        if (ca.get("state") !== p.ERROR) {
                            if (this.getConfig().disableSeekForward && a > this._model.get("position"))
                                return void fa.trigger(q.JWPLAYER_SEEK_FORWARD_FORBIDDEN);
                    ...
                    function K() {
                        if (D()) {
                            ...
                            return ca.get("item") === ca.get("playlist").length - 1 ? void (ca.get("repeat") ? J({
                                reason: "repeat"
                            }) : (ca.set("state", p.COMPLETE),
                            fa.trigger(q.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void J({
                                reason: "playlist"
                            })
                        }
                    }
                    function L(a) {
                        ga() && (a = parseInt(a, 10) || 0,
                        ga().setCurrentQuality(a))
                    }
                    function M() {
                    ...
                    var Z, $, _, aa, ba, ca = this._model, da = !1, ea = !1, fa = this, ga = function() {
                        return ca.getVideo()
                    }, ha = new h;
                    ha.track(ca);
                    var ia = new a(g,ha);
                ...
                showView: function(a) {
                    ...
                    this.currentContainer)) && (this.currentContainer.parentElement && this.currentContainer.parentElement.replaceChild(a, this.currentContainer),
              ...
              , j = function(a, b, f) {
                ...
                function l(a) {
                    ...
                    m && t + 1 < m.length) {
                        ...
                        a.type === c.JWPLAYER_MEDIA_COMPLETE && (this.trigger(c.JWPLAYER_MEDIA_COMPLETE, d),
                        this.trigger(c.JWPLAYER_PLAYLIST_COMPLETE, {})),
                        this.destroy()
                }
                var m, n, o, p, q, r = h(b), s = new r(a,b), t = 0, u = {}, v = g.bind(function(a) {
                    ...
                    s && s._adModel && s._adModel.get("state") === d.PAUSED && b.get("controls") && (a.setFullscreen(),
                    a.play())
                }, this);
                this.type = "instream",
                this.init = function() {
                    ...
                    a.checkBeforePlay() || 0 === p && !o.checkComplete() ? (p = 0,
                    b.set("preInstreamState", "instream-preroll")) : o && o.checkComplete() || b.get("state") === d.COMPLETE ? b.set("preInstreamState", "instream-postroll") : b.set("preInstreamState", "instream-midroll");
                    var g = b.get("state");
                ...
                this.loadItem = function(a, d) {
                    ...
                    f && (s._adModel.set("skipMessage", u.skipMessage),
                        ...
                        this.swf.on("throttle", function(c) {
                            ...
                            "resume" === c.state)
                                ...
                                a = setTimeout(function() {
                                    d._adModel.get("state") === e.PLAYING && (b = !0,
                                    d.instreamPause())
                                }, 250)
                            }
                        }, this)
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(20), c(36), c(57), c(43), c(21), c(1), c(2), c(4), c(8), c(17)],
        void 0 !== (e = function(a, b, d, e, f, g, h, i, j, k) {
            ...
            function s(a, b) {
                if (q(b.get("playlist")) && window.videojs && !window.videojs.m3u8) {
            ...
            function y(a, b) {
                ...
                g.isString(c) ? (M = new d,
                M.on(i.JWPLAYER_PLAYLIST_LOADED, function(c) {
                    b.set("playlist", c.playlist),
                    b.set("feedid", c.feedid),
                    a()
                }),
                M.on(i.JWPLAYER_ERROR, g.partial(D, a)),
                M.load(c)) : a()
            }
            ...
            function A(a) {
                var b = ""
                  , c = "";
                return h.flashVersion() || h.isMobile() ? h.flashVersion() && h.flashVersion() < 11.2 ? (b = 'Flash Player版本必须大于11.2, <a href="https://get.adobe.com/cn/flashplayer/" target="_blank">更新Flash Player</a>',
                c = "102") : h.isMobile() && (h.isRtmp(a[0].file) || h.isFlv(a[0].file)) && (b = "手机上不能播放rtmp或flv格式的视频",
                c = "111") : (b = '未检测到Flash Player，请到<a href="https://get.adobe.com/cn/flashplayer/" target="_blank">安装</a>',
                c = "101"),
                {
                    errorMessage: b,
                    errorCode: c
            ...
            function E(a, b) {
                if (g.contains(f.SkinsLoadable, a))
                    return b + "skins/" + a + ".css"
            }
            function F(a) {
            ...
            function G(a, b) {
                var c = b.get("skin")
                  , d = b.get("skinUrl");
                if (g.contains(f.SkinsIncluded, c))
                    return void a();
                if (!d) {
                    d = E(c, f.repo)
                }
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a) {
            ...
            return function(e) {
                ...
                b(g),
                g.length || (g = e.getElementsByTagName("tt:p"),
            ...
            return function(d, e) {
                for (var f = [], g = [], h = b.xmlAttribute, i = "default", j = "label", k = "file", l = 0; l < d.childNodes.length; l++) {
                    ...
                    if ("jwplayer" === m.prefix) {
                        var n = a.localName(m);
                        "source" === n ? (delete e.sources,
                        f.push({
                            file: h(m, k),
                            "default": h(m, i),
                            label: h(m, j),
                            type: h(m, "type")
                        })) : "track" === n ? (delete e.tracks,
                        g.push({
                            file: h(m, k),
                            "default": h(m, i),
                            kind: h(m, "kind"),
                            label: h(m, j)
                        })) : (e[n] = c.serialize(a.textContent(m)),
                        "file" === n && e.sources && delete e.sources)
                    }
                    e[k] || (e[k] = e.link)
                }
                if (f.length)
                    for (e.sources = [],
                    l = 0; l < f.length; l++)
                        f[l].file.length > 0 && (f[l][i] = "true" === f[l][i],
                        f[l].label.length || delete f[l].label,
                        e.sources.push(f[l]));
                if (g.length)
                    for (e.tracks = [],
                    l = 0; l < g.length; l++)
                        g[l].file.length > 0 && (g[l][i] = "true" === g[l][i],
                        g[l].kind = g[l].kind.length ? g[l].kind : "captions",
                        g[l].label.length || delete g[l].label,
                        e.tracks.push(g[l]));
                return e
            }
        }
            ...
            return function i(a, b) {
                ...
                for (k = 0; k < h(a); k++)
                    ...
                    "media" === j.prefix) {
                        ...
                        case "content":
                            if (e(j, "duration") && (b.duration = c.seconds(e(j, "duration"))),
                            e(j, "url")) {
                                b.sources || (b.sources = []);
                                var n = {
                                    file: e(j, "url"),
        ...
        void 0 !== (e = function(a, b, c, d) {
            ...
            g.filterPlaylist = function(a, b, d, e, g, j, k) {
                ...
                return c.each(a, function(a) {
                    ...
                    a.sources.length && (a.file = a.sources[0].file,
                    (a.preload || g) && (a.preload = a.preload || g),
                    (a.feedid || j) && (a.feedid = a.feedid || j),
                    l.push(a))
                }),
                l
            }
            ...
            var h = function(a, d, e, g, h) {
                return c.compact(c.map(a, function(a) {
                    if (c.isObject(a))
                        return void 0 !== d && null !== d && (a.androidhls = d),
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d, e, f) {
            ...
            return function(i, j) {
                function k() {
                    q || (q = !0,
                    p = f.loaderstatus.COMPLETE,
                    o.trigger(c.COMPLETE))
                }
                function l() {
                    if (!s && (j && 0 !== e.keys(j).length || k(),
                    !q)) {
                        var d = i.getPlugins();
                        n = e.after(r, k),
                ...
                ,
                this.load = function() {
                    if (b.exists(j) && "object" !== b.typeOf(j))
                        return void l();
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b) {
            ...
            function e(a) {
                var b = [];
                for (var c in a)
                    "object" === f(a[c]) ? b.push(c + "=" + encodeURIComponent(JSON.stringify(a[c]))) : b.push(c + "=" + a[c]);
                return b.join("&")
            }
            function g(a) {
                if (!s) {
            ...
            var h, i, j, k, l = {}, m = document.getElementsByTagName("script")[0].parentNode, n = "https://drm.media.baidubce.com:8888/v1/sdk-player", o = 0, p = 0, q = !1, r = (new Date).getTime() + "", s = !1;
            return function(a, b) {
                if (h = b,
                ...
                a.on("idle", function(a) {
                    "complete" === a.reason && (o += h.get("duration") - p,
                    f = {
                        action: "/user/web/end",
                        videoUrl: h.get("file") || h.getCurrentItem().file,
                        playInterval: o,
                ...
                var t, u = !0, v = !1, w = 0, x = 0;
                a.on("alive", function() {
                    return v = !0,
                    u ? void (u = !1) : void (t && (w = (new Date).getTime() - t,
                    x++,
                    f = {
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d, e, f, g, h, i) {
            ...
            function l(l, u) {
                function v() {
                    ua && (ea(Fa.audioTracks),
                    oa.setTextTracks(Fa.textTracks),
                    Fa.setAttribute("jw-loaded", "data"))
                }
                function w() {
                ...
                function A() {
                    o(sa),
                    qa = !0,
                    ua && (oa.state === f.STALLED ? oa.setState(f.PLAYING) : oa.state === f.PLAYING && (sa = setTimeout(X, p)),
                    Fa.duration === 1 / 0 && 0 === Fa.currentTime || (E(D()),
                    C(Fa.currentTime),
                    B(Y(), la, ka),
                    oa.state === f.PLAYING && oa.trigger(e.JWPLAYER_MEDIA_TIME, {
                        position: la,
                        duration: ka
                    })))
                }
                function B(a, b, c) {
                    a === ta && c === ka || (ta = a,
                    oa.trigger(e.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 100 * a,
                        position: b,
                        duration: c
                    }))
                ...
                function H() {
                    ua && (Fa.muted && (Fa.muted = !1,
                    Fa.muted = !0),
                    Fa.setAttribute("jw-loaded", "meta"),
                    F())
                }
                function I() {
                    ma || (ma = !0,
                    oa.trigger(e.JWPLAYER_MEDIA_BUFFER_FULL))
                }
                function J() {
                ...
                function M() {
                    ua && (m.hls && m.hls.reconnecttime ? setTimeout(function() {
                        return oa.load(n)
                    }, 1e3 * m.hls.reconnecttime) : t < m.retryCount && n ? (t++,
                    setTimeout(function() {
                        return oa.load(n)
                    }, 3e3)) : (b.log("Error playing media: %o %s", Fa.error, Fa.src),
                    oa.trigger(e.JWPLAYER_MEDIA_ERROR, {
                        message: "加载失败: 未开始直播或直播已结束",
                        code: "111"
                    })))
                }
                function N(a) {
                ...
                function R(a) {
                    ...
                    Aa = -1,
                    Ba = -1,
                    Da.reason || (Da.reason = "initial choice",
                    Da.level = {}),
                    qa = !1,
                    ma = !1,
                    ...
                    b.src = a.file,
                    Fa.src !== b.src && (Fa.setAttribute("jw-loaded", "none"),
                    Ga.src({
                        src: a.file,
                ...
                function S() {
                    Fa && (oa.disableTextTrack(),
                    Fa.removeAttribute("crossorigin"),
                    Fa.removeAttribute("preload"),
                    Fa.removeAttribute("src"),
                    Fa.removeAttribute("jw-loaded"),
                    Fa.removeAttribute("jw-played"),
                    c.emptyElement(Fa),
                    va = -1,
                    Ca = null,
                    !q && "load"in Fa && Ga.load())
                }
                function T() {
                    for (var a = Fa.seekable ? Fa.seekable.length : 0, b = 1 / 0; a--; )
                        b = Math.min(b, Fa.seekable.start(a));
                    return b
                }
                function U() {
                    for (var a = Fa.seekable ? Fa.seekable.length : 0, b = 0; a--; )
                        b = Math.max(b, Fa.seekable.end(a));
                    return b
                }
                function V() {
                    oa.seeking = !1,
                ...
                function Z() {
                    if (ua && oa.state !== f.IDLE && oa.state !== f.COMPLETE) {
                        ...
                        va = -1,
                        xa = !0,
                        oa.trigger(e.JWPLAYER_MEDIA_BEFORECOMPLETE),
                        !ua)
                            return;
                        $()
                    }
                ...
                function aa() {
                    for (var a = -1, b = 0; b < Fa.audioTracks.length; b++)
                        if (Fa.audioTracks[b].enabled) {
                            a = b;
                            break
                        }
                    fa(a)
                ...
                function fa(a) {
                    Fa && Fa.audioTracks && za && a > -1 && a < Fa.audioTracks.length && a !== Aa && (Fa.audioTracks[Aa].enabled = !1,
                    Aa = a,
                    Fa.audioTracks[Aa].enabled = !0,
                    oa.trigger("audioTrackChanged", {
                        currentTrack: Aa,
                        tracks: za
                    }))
                }
                ...
                }, qa = !1, ra = 0, sa = -1, ta = -1, ua = !0, va = -1, wa = !!u.sdkplatform, xa = !1, ya = !1, za = null, Aa = -1, Ba = -1, Ca = null, Da = {
                    level: {}
                }, Ea = document.getElementById(l), Fa = Ea ? Ea.querySelector("video") : void 0;
                ...
                this.setToken = function(a) {
                    for (var b = {
                        ...
                        b.token[a[c].file] = a[c].tokenText;
                    setTimeout(function() {
                        Ga.tech({
                ...
                this.init = function(a, b) {
                    ...
                    this.setupSideloadedTracks(a.tracks),
                    Ca = this.itemTracks,
                    b.minBufferLength > 0 && (videojs.Hls.MAX_GOAL_BUFFER_LENGTH = b.minBufferLength,
                    b.minBufferLength < 30 && (videojs.Hls.GOAL_BUFFER_LENGTH = b.minBufferLength)))
                }
                ,
                this.load = function(a) {
                    ua && (O(a.sources),
                    ...
                    Q(a.starttime || 0, a.duration || 0))
                }
                ,
                this.play = function() {
                    return oa.seeking ? (oa.setState(f.LOADING),
                    void oa.once(e.JWPLAYER_MEDIA_SEEKED, oa.play)) : void Ga.play()
                }
                ,
                this.pause = function() {
                    o(sa),
                ...
                this.seek = function(a) {
                    if (ua)
                        if (a < 0 && (a += T() + U()),
                        0 === ra && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
                ...
                ,
                this.resize = function(b, c, d) {
                    if (!(b && c && Fa.videoWidth && Fa.videoHeight))
                        return !1;
                    var e = {
                        objectFit: ""
                    };
                ...
                this.setPlaybackRate = function(a) {
                    m.isLive || (Fa.playbackRate = a,
                    this.trigger(e.JWPLAYER_PLAYBACKRATE, {
                        playbackRate: a
                    }))
                }
            }
            var m, n, o = window.clearTimeout, p = 256, q = b.isMSIE(), r = b.isFF(), s = "videojs", t = 0, u = function() {};
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            function e(e, g, j, k, l, m) {
                ...
                a.isMSIE() || a.isPoorIE()) {
                    ...
                    for (var p = g.getElementsByTagName("object"), q = p.length; q--; )
                        p[q].id === j && (n = p[q])
                } else
                ...
                n.triggerFlash = function(b) {
                    ...
                    if ("setup" !== b && d.queueCommands || !d.__externalCall) {
                        for (var e = d.__commandQueue, g = e.length; g--; )
                            e[g][0] === b && e.splice(g, 1);
                      ...
                      , j = a.tryCatch(function() {
                        if (i.length) {
                            for (var a = i.length; a--; )
                                "object" === f(i[a]) && c.each(i[a], h);
                            var e = JSON.stringify(i);
                            d.__externalCall(b, e)
                        } else
                            d.__externalCall(b)
                    });
                    return j instanceof a.Error && (console.error(b, j),
                    "setup" === b) ? (j.name = "Failed to setup flash",
                    j) : d
                }
                ,
                n.__commandQueue = [],
            ...
            function g(a) {
                a && a.parentNode && (a.style.display = "none",
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function() {
            ...
            return a.getElementsByClassName = function(a, b, c) {
                ...
                for (var d = [], e = b.getElementsByTagName(c), f = e.length, g = new RegExp("(^|\\s)" + a + "(\\s|$)"), h = 0; h < f; h++)
                    g.test(e[h].className) && d.push(e[h]);
                return d
            }
            ,
            ...
            return c.extend(f.prototype, {
                ...
                loadAdv: function(a) {
                    ...
                    if (d && d[a] && d[a].image) {
                        ...
                        if (c.isString(f) ? (f = encodeURI(f),
                        i.backgroundImage = 'url("' + f + '")') : i.backgroundImage = "",
                        "end" === a && (i["z-index"] = 0),
                        "pause" === a) {
                ...
                beginStartAdv: function() {
                    if (this.startAdvPlayed)
                        return void this.model.loadVideo();
        ...
        void 0 !== (e = function(a, b, c, d) {
            ...
            return function(g) {
                function h(b) {
                    ...
                    b ? (t.innerHTML = b,
                    s.className = c + " jw-captions-window-active") : (s.className = c,
                    a.empty(t))
                }
                function i(a) {
                    q = a,
                ...
                function m(a, c, d) {
                    if (b.css("#" + a + " .jw-video::-webkit-media-text-track-display", c, a),
                    b.css("#" + a + " .jw-video::cue", d, a),
                    d.backgroundColor) {
                ...
                this.setup = function(a, c) {
                    ...
                    s.className = "jw-captions-window jw-reset",
                    t.className = "jw-captions-text jw-reset",
                    u = d.extend({}, f, c),
                    c) {
                        var h = u.fontOpacity
                          , i = u.windowOpacity
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d) {
            return function(e, f, g) {
                function h(a) {
                    if (!e.get("flashBlocked"))
                        return k ? void k(a) : void o.trigger(a.type === b.touchEvents.CLICK ? "click" : "tap")
                }
                function i() {
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            }),
            {
                ...
                chaptersLoaded: function(b) {
                    ...
                    a.isArray(d) && (a.each(d, this.addCue, this),
                    this.drawCues())
                },
        ...
        void 0 !== (e = function(a, b, c, d) {
            return a.extend({
                ...
                setup: function(a, e) {
                    ...
                    e && this.activeContents.length > 1 && (b.removeClass(this.el, "jw-off"),
            ...
            return a.extend({
                setup: function(a, f, g) {
                    ...
                    var h = a.length > 2 || 2 === a.length && g && !1 === g.toggle
                      , i = !h && 2 === a.length;
                    if (b.toggleClass(this.el, "jw-toggle", i),
                    ...
                    h) {
                        ...
                        i && this.iconUI.on("click tap", this.toggleValueListener);
                    this.selectItem(f)
                },
                ...
                select: function(a) {
                    if (a.target.parentElement === this.content) {
                        ...
                        e && (this.trigger("select", parseInt(e.split("-")[2])),
                ...
                selectItem: function(a) {
                    if (this.content)
                        ...
                        b.toggleClass(this.el, "jw-off", 0 === a);
            ...
            return c.extend({
                ...
                onSelect: function(c) {
                    ...
                    if ("UL" !== d.tagName) {
                        ...
                        f && (this.trigger("select", parseInt(f.split("-")[2])),
                        this.closeTooltip())
                    }
                },
                selectItem: function(a) {
        ...
        void 0 !== (e = function(a, b, c) {
            ...
            return {
                loadThumbnails: function(a) {
                    a && (this.vttPath = a.split("?")[0].split("/").slice(0, -1).join("/"),
                    this.individualImage = null,
                    b.ajax(a, this.thumbnailsLoaded.bind(this), this.thumbnailsFailed.bind(this), {
                        plainText: !0
                    }))
                },
                ...
                loadThumbnail: function(b) {
                    ...
                    if (c.indexOf("#xywh") > 0)
                        ...
                        c && (this.individualImage ? (d.width = this.individualImage.width,
                        d.height = this.individualImage.height) : (this.individualImage = new Image,
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(1), c(2), c(21), c(45), c(22), c(131), c(135)],
        void 0 !== (e = function(a, b, c, d, e, f, g) {
            var h = e.extend({
                setup: function() {
              ...
              , i = d.extend({
                ...
                limit: function(d) {
                    if (this.activeCue && a.isNumber(this.activeCue.pct))
                ...
                performSeek: function() {
                    var a, c = this.seekTo, d = this._model.get("duration"), e = b.adaptiveType(d);
                    0 === d ? this._api.play() : "DVR" === e ? (a = (100 - c) / 100 * d,
                    this._api.seek(a)) : this._model.attributes.controlbar.canDrag && (a = c / 100 * d,
                    this._api.seek(Math.min(a, d - .25)))
                },
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(2), c(1), c(3), c(21), c(9), c(45), c(136), c(133), c(134), c(137), c(132)],
        void 0 !== (e = function(a, b, c, d, e, f, g, h, i, j, k) {
            ...
            return b.extend(p.prototype, c, {
                ...
                build: function() {
                    var a, c, d, e, h = this, p = new g(this._model,this._api), q = new k("jw-icon-more");
                    !1 !== this._model.get("visualplaylist") && (a = new i("jw-icon-playlist")),
                    this._isMobile || (e = l("jw-icon-volume", this._api.setMute),
                    c = new f("jw-slider-volume","horizontal"),
                    d = new j(this._model,"jw-icon-volume")),
                    this.elements = {
                        alt: m("jw-text-alt"),
                ...
                onMediaModel: function(c, d) {
                    ...
                    d.on("change:state", function(b, c) {
                        "complete" === c && (this.elements.drawer.closeTooltip(),
                        a.removeClass(this.el, "jw-drawer-expanded"))
                    }, this),
                    d.on("change:playbackRate", function(a, b) {
                        for (var c = this._model.get("playRateConfig"), d = -1, e = 0; e < c.length; e++)
                            c[e].label === "×" + b && (d = e);
                ...
                renderVolume: function(b, c, d) {
                    ...
                    this.elements.volumetooltip && (this.elements.volumetooltip.volumeSlider.render(b ? 0 : c),
                    a.toggleClass(this.elements.volumetooltip.element(), "jw-off", b)),
                    this.elements.volumetooltip && this.elements.volumetooltip.valuetip && (e = this.elements.volumetooltip.valuetip,
                    b ? e.innerHTML = "0%" : 100 === c && c > d && this._model.get("provider") && /^flash/.test(this._model.get("provider").name) ? e.innerHTML = "100%(按↑可以继续增大音量)" : e.innerHTML = c + "%")
                },
                ...
                onDuration: function(b, c) {
                    var d;
                    "DVR" === a.adaptiveType(c) ? (d = "Live",
                    this.clearCompactMode()) : d = a.timeFormat(c),
                ...
                getVisibleBounds: function() {
                    var b, c = this.el;
                    return "table" === (getComputedStyle ? getComputedStyle(c) : c.currentStyle).display ? a.bounds(c) : (c.style.visibility = "hidden",
                ...
                addCues: function(a) {
                    ...
                    0 === a.length && this.elements.time.resetChapters(),
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b, c, d, e, f) {
            ...
            return function(i) {
                var j, k, l = new Image, m = d.extend({}, i.get("logo"));
                return d.extend(this, e),
                this.setup = function(e) {
                    if (k = d.extend({}, h, m),
                    k.hide = "true" === k.hide.toString(),
                    j = b.createElement(f()),
                    k.file) {
                        k.hide && b.addClass(j, "jw-hide"),
                        b.addClass(j, "jw-logo-" + (k.position || h.position)),
                        "top-right" === k.position && (i.on("change:dock", this.topRight, this),
                        i.on("change:controls", this.topRight, this),
                        this.topRight(i)),
                        i.set("logo", k),
                        l.onload = function() {
                            var a = {
                            ...
                            if (k.margin !== h.margin) {
                                ...
                                3 === b.length && (a["margin-" + b[1]] = k.margin,
                                a["margin-" + b[2]] = k.margin)
                            }
                            g(j, a),
    ...
    , function(a, b, c) {
        ...
        void 0 !== (e = function(a, b) {
            ...
            function d(a, c) {
                return a.get("autostart") && !b.isMobile() || a.get("item") > 0 ? (this.setImage(null),
                a.off("change:state", null, this),
                void a.on("change:state", function(a, b) {
        ...
        void 0 !== (e = function(a, b, c, d, e) {
            ...
            return c.extend(f.prototype, {
                ...
                rightClick: function(a) {
                    ...
                    !this.mouseOverContext && (this.hideMenu(),
                    this.showMenu(a),
                    !1)
                },
                getOffset: function(b) {
                    ...
                    if (a.isIE() && (a.hasClass(c, "jw-video") || a.hasClass(c, "jw-warning")))
                        return {
                            x: d,
                            y: e + 40
                        };
                    for (; c !== this.playerElement; )
                        d += c.offsetLeft,
                        e += c.offsetTop,
                        c = c.parentNode;
                ...
                hideMenu: function() {
                    this.mouseOverContext || (a.removeClass(this.playerElement, "jw-flag-rightclick-open"),
    ...
    , function(a, b, c) {
        var d, e;
        d = [c(2), c(4), c(3), c(21), c(7), c(129), c(130), c(139), c(140), c(142), c(138), c(144), c(128), c(143), c(145), c(146), c(1), c(173)],
        void 0 !== (e = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
            ...
            return function(w, x) {
                ...
                function z(b) {
                    ...
                    "-" === b ? c = d > 100 ? -50 : -10 : (c = d >= 100 ? 50 : 10,
                    d < 100 && d + c > 100 && (c = 100 - d));
                    var e = x.getVideo()
                ...
                function B(a) {
                    ...
                    return /13|32|37|38|39|40/.test(a.keyCode) ? (a.preventDefault && a.preventDefault(),
                    !1) : void 0
                }
                function C() {
                    Oa = !1,
                ...
                function F() {
                    ...
                    return document.body.contains(la) ? d && e && (d === oa && e === pa || (oa = d,
                    pa = e,
                    clearTimeout(La),
                    La = setTimeout(Z, 50),
                    x.set("containerWidth", d),
                    x.set("containerHeight", e),
                    Pa.trigger(b.JWPLAYER_RESIZE, {
                        width: d,
                        height: e
                    }))) : (a.removeEventListener(window, "resize", F),
                    u && a.removeEventListener(window, "orientationchange", F)),
                    c
                }
                function G(b, c) {
                    c = c || !1,
                ...
                function K(b) {
                    b && !u && (a.addEventListener(b.element(), "mousemove", N, !1),
                    a.addEventListener(b.element(), "mouseout", O, !1))
                }
                function L() {
                ...
                function M(a) {
                    a.link ? (w.pause(!0),
                    w.setFullscreen(!1),
                    window.open(a.link, a.linktarget)) : x.get("controls") && w.play({
                        reason: "interaction"
                    })
                }
                function N() {
                ...
                function Q(b, c) {
                    c ? (Ca && Ca.destroy(),
                    a.addClass(la, "jw-flag-flash-blocked")) : (Ca && Ca.setup(x, la, la),
                    a.removeClass(la, "jw-flag-flash-blocked"))
                }
                function R() {
                ...
                function S() {
                    ...
                    var l = x.get("height");
                    u && ("string" == typeof l || l >= 1.5 * Ia) ? a.addClass(la, "jw-flag-touch") : (Ca = new o,
                    Ca.setup(x, la, la)),
                    ra = new k(w,x),
                ...
                function V(b, c, d) {
                    ...
                    d = !!d,
                    d && (f = f.replace(/\s*aspectMode/, ""),
                    la.className !== f && (la.className = f),
                    a.style(la, {
                        display: "block"
                    }, d)),
                    a.exists(b) && a.exists(c) && (x.set("width", b),
                    x.set("height", c)),
                    e = {
                        width: b
                    },
                ...
                function Z(b, c) {
                    ...
                    var d = x.getVideo();
                    if (d) {
                        d.resize(b, c, x.get("stretching")) && (clearTimeout(La),
                        La = setTimeout(Z, 250)),
                        Aa.resize(),
                ...
                function aa(b, c) {
                    c ? (a.addClass(b, "jw-flag-fullscreen"),
                    s(document.body, {
                        "overflow-y": "hidden"
                    }),
                    ca()) : (a.removeClass(b, "jw-flag-fullscreen"),
                    s(document.body, {
                        "overflow-y": ""
                    })),
                    Z()
                ...
                function ca() {
                    Ka || (a.removeClass(la, "jw-flag-user-inactive"),
                    ra.checkCompactMode(na.clientWidth)),
                    Ka = !0,
                    clearTimeout(Ga),
                    Ga = setTimeout(ba, Ha)
                }
                ...
                function ka(b, c) {
                    if (Da = c,
                    clearTimeout(Ma),
                    c === e.COMPLETE || c === e.IDLE ? Ma = setTimeout(ja, 100) : ja(),
                    ia())
                        return void a.addClass(na, "jw-media-show");
                    switch (c) {
                    case e.PLAYING:
                        ta && ta.hide(),
                        Z(),
                ...
                var la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa, xa, ya, za, Aa, Ba, Ca, Da, Ea, Fa, Ga = -1, Ha = 2e3, Ia = 40, Ja = !1, Ka = !1, La = -1, Ma = -1, Na = !1, Oa = !1, Pa = q.extend(this, c);
                this.model = x,
                this.api = w,
                ...
                this.setup = function() {
                    ...
                    !0 === x.get("skin-loading") && (a.addClass(la, "jw-flag-skin-loading"),
                    x.once("change:skin-loading", function() {
                    ...
                    za.setup(d),
                    a.isPoorIE())
                        a.style(a.getElementsByClassName("jw-marquee", la)[0], {
                            display: "none"
                        });
                    else if (ta = new m(x,w),
                    x.get("imageAdvs") && la.appendChild(ta.element()),
                    x.get("marquee").show) {
                    ...
                    for (var g = v.length; g--; )
                        a.addEventListener(document, v[g], _, !1);
                    a.removeEventListener(window, "resize", F),
                    a.addEventListener(window, "resize", F, !1),
                    u && (a.removeEventListener(window, "orientationchange", F),
                    a.addEventListener(window, "orientationchange", F, !1)),
                    ...
                    x.on("alive", function() {
                        "idle" !== Pa.model.get("state") && (Pa.setAltText("直播中"),
                        a.toggleClass(la, "jw-flag-live", !0),
                        c.style.display = "none",
                        a.getElementsByClassName("jw-controlbar", la)[0].style.removeProperty("display"))
                    }),
                    x.on("noLiveStream", function() {
                        "idle" !== Pa.model.get("state") && x.get("isLive") && (Pa.setAltText("无直播流"),
                        a.toggleClass(la, "jw-flag-live", !0),
                        x.get("image") && (c.style.display = "block"),
                        a.getElementsByClassName("jw-controlbar", la)[0].style.display = "block")
                    }),
                ...
                var Sa = function(b, c) {
                  ...
                  , Ta = function(b, c) {
                    var d = x.getVideo();
                    Na ? (c ? Ea.apply(la) : Fa.apply(document),
                    aa(la, c)) : a.isIE() ? aa(la, c) : (qa && qa.getVideo() && qa.getVideo().setFullscreen(c),
                    d.setFullscreen(c)),
                ...
                this.destroyInstream = function() {
                    if (Ja = !1,
                    qa && (qa.off(null, null, this),
                    qa = null),
                    this.setAltText(""),
                    a.removeClass(la, "jw-flag-ads"),
                    a.removeClass(la, "jw-flag-ads-hide-controls"),
                    x.getVideo) {
                ...
                this.getSafeRegion = function(b) {
                    var c = {
                      ...
                      , d = x.get("dock");
                    return d && d.length && x.get("controls") && (c.y = xa.element().clientHeight,
                    c.height -= c.y),
                    b = b || !a.exists(b),
        ...
        b["default"] = function(a) {
            a.registerHelper("each", function(a, b) {
                ...
                var e = b.fn
                  ...
                  , j = void 0
                  , k = void 0;
                if (b.data && b.ids && (k = d.appendContextPath(b.data.contextPath, b.ids[0]) + "."),
    ...
    , function(a, b, c) {
        ...
        function h(a, b, c) {
            ...
            var d = void 0;
            if (c.fn && c.fn !== i && (c.data = p.createFrame(c.data),
            d = c.data["partial-block"] = c.fn,
            d.partials && (c.partials = m.extend({}, c.partials, d.partials))),
            void 0 === a && d && (a = d),
            void 0 === a)
        ...
        a.exports = (d["default"] || d).template({
            1: function(a, b, c, d, e) {
                ...
                return '    <div class="jw-dock-button jw-background-color jw-reset' + (null != (f = c["if"].call(h, null != b ? b.btnClass : b, {
                    ...
                    inverse: a.noop,
                    data: e
                })) ? f : "") + '" button="' + a.escapeExpression((g = null != (g = c.id || (null != b ? b.id : b)) ? g : c.helperMissing,
            ...
            2: function(a, b, c, d, e) {
                var f;
                return " " + a.escapeExpression((f = null != (f = c.btnClass || (null != b ? b.btnClass : b)) ? f : c.helperMissing,
            ...
            4: function(a, b, c, d, e) {
                var f;
                return "style='background-image: url(\"" + a.escapeExpression((f = null != (f = c.img || (null != b ? b.img : b)) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "img",
                    hash: {},
                    data: e
            ...
            6: function(a, b, c, d, e) {
                var f;
                return '        <div class="jw-overlay jw-background-color jw-reset">\n            <span class="jw-text jw-dock-text jw-reset">' + a.escapeExpression((f = null != (f = c.tooltip || (null != b ? b.tooltip : b)) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "tooltip",
                    hash: {},
                    data: e
    ...
    , function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            ...
            main: function(a, b, c, d, e) {
                ...
                return '<div id="' + k((g = null != (g = c.id || (null != b ? b.id : b)) ? g : i,
                typeof g === j ? g.call(h, {
                    name: "id",
                    hash: {},
                    data: e
                }) : g)) + '"class="jw-skin-' + k((g = null != (g = c.skin || (null != b ? b.skin : b)) ? g : i,
                typeof g === j ? g.call(h, {
                    name: "skin",
                    hash: {},
                    data: e
                }) : g)) + ' jw-error jw-reset">\n    <div class="jw-title jw-reset">\n        <div class="jw-title-primary jw-reset">' + (null != (g = null != (g = c.title || (null != b ? b.title : b)) ? g : i,
                f = typeof g === j ? g.call(h, {
                    name: "title",
                    hash: {},
                    data: e
                }) : g) ? f : "") + '</div>\n        <div class="jw-title-secondary jw-reset">' + k((g = null != (g = c.body || (null != b ? b.body : b)) ? g : i,
                typeof g === j ? g.call(h, {
                    name: "body",
                    hash: {},
                    data: e
    ...
    , function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            1: function(a, b, c, d, e) {
                var f;
                return 'src="' + a.escapeExpression((f = null != (f = c.file || (null != b ? b.file : b)) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "file",
                    hash: {},
                    data: e
    ...
    , function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            1: function(a, b, c, d, e) {
                ...
                return "        <li class='jw-text jw-option jw-item-" + g((f = null != (f = c.index || e && e.index) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "index",
                    hash: {},
                    data: e
    ...
    , function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            ...
            main: function(a, b, c, d, e) {
                var f;
                return '<div id="' + a.escapeExpression((f = null != (f = c.id || (null != b ? b.id : b)) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "id",
                    hash: {},
                    data: e
    ...
    , function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            ...
            2: function(a, b, c, d, e) {
                var f, g = a.escapeExpression, h = a.lambda;
                return "                <li class='jw-option jw-text jw-active-option jw-item-" + g((f = null != (f = c.index || e && e.index) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "index",
                    hash: {},
                    data: e
            ...
            4: function(a, b, c, d, e) {
                var f, g = a.escapeExpression, h = a.lambda;
                return "                <li class='jw-option jw-text jw-item-" + g((f = null != (f = c.index || e && e.index) ? f : c.helperMissing,
                "function" == typeof f ? f.call(null != b ? b : {}, {
                    name: "index",
                    hash: {},
                    data: e
        ...
        a.exports = (d["default"] || d).template({
            1: function(a, b, c, d, e) {
                ...
                return '        <li class="jw-reset' + (null != (f = c["if"].call(h, null != b ? b.featured : b, {
                    ...
                    inverse: a.noop,
                    data: e
                })) ? f : "") + '">\n            <a href="' + k((g = null != (g = c.link || (null != b ? b.link : b)) ? g : i,
                typeof g === j ? g.call(h, {
                    name: "link",
                    hash: {},
                    data: e
                    ...
                    inverse: a.noop,
                    data: e
                })) ? f : "") + "                " + k((g = null != (g = c.title || (null != b ? b.title : b)) ? g : i,
                typeof g === j ? g.call(h, {
                    name: "title",
                    hash: {},
                    data: e
    ...
    , function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            ...
            main: function(a, b, c, d, e) {
                ...
                return '<div class="' + j((f = null != (f = c.className || (null != b ? b.className : b)) ? f : h,
                typeof f === i ? f.call(g, {
                    name: "className",
                    hash: {},
                    data: e
                }) : f)) + " " + j((f = null != (f = c.orientation || (null != b ? b.orientation : b)) ? f : h,
                typeof f === i ? f.call(g, {
                    name: "orientation",
                    hash: {},
                    data: e
