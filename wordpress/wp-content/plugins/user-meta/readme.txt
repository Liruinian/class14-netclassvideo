...
Tags: user-management-plugin, user-profile, user-registration, user-login, front-end
Requires at least: 4.7
Tested up to: 5.4
Stable tag: 2.1
Copyright: Khaled Hossain, https://user-meta.com
License: GPLv2
License URI: http://www.gnu.org/licenses/gpl-2.0.html

A well-designed, feature-rich, and easy to use user management plugin that allows user login, reset-password, profile update and user registration with extra fields, all on front-end and many more.
