...
class FieldBuilder
{
    ...
    public function title()
    {
        ...
        return '<span class="um_field_panel_title">ID:<span class="um_field_id">' . $this->id . '</span>' . ' (<span>' . $typeLabel . '</span>) ' . '<span class="um_field_label">' . esc_html($label) . '</span></span>' . '<input type="hidden" class="um_field_type" value="' . $this->type . '"/>';
    }
}